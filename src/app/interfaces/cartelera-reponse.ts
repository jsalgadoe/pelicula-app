// To parse this data:
//
//   import { Convert, Cartelera } from "./file";
//
//   const cartelera = Convert.toCartelera(json);
//
...
export class Convert {
  public static toCartelera(json: string): Cartelera {
    return cast(JSON.parse(json), r("Cartelera"));
  }

  public static carteleraToJson(value: Cartelera): string {
    return JSON.stringify(uncast(value, r("Cartelera")), null, 2);
  }
}
